...
export const categories: Category[] = [
  ...
  },
  {
    ...
    description:
      'Gleiche Mechanik wie das Standard-Plissee, aber mit deutlich feinerem Spezialgewebe. Es hält neben Insekten auch einen erheblichen Teil des Blütenstaubs zurück, der sonst durchs offene Fenster kommt.',
    mesh: 'Feinmaschiges Pollenschutzgewebe',
    bestFor: 'Schlafzimmer und Kinderzimmer von Allergikerinnen und Allergikern',
    priceFactor: 1.95,
    features: [
      'Hält Blütenstaub weitgehend zurück',
      'Reduziert zusätzlich Feinstaub von der Strasse',
      'Waschbar, ohne die Wirkung zu verlieren',
